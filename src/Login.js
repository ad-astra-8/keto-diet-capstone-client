            ...
            <section className="login-component">
                ...
                <div className="form-div">
                    ...
                    {errorMessage}
                        ...
                        <input className="login-input" type="text" name="loginUsername" placeholder="my username" required />
                        <p className="error-message">username is not valid, please try again</p>
                        <label htmlFor="password">Password:</label>
                        <input className="login-input" type="text" name="loginPassword" placeholder="my password" required />
